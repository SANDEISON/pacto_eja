...
class EducadorEscola(models.Model):
    class Funcao(models.TextChoices):
        ...
        ESTUDANTE_GRADUACAO = "estudante_graduacao", "Estudante de graduação"
        ESTUDANTE_POS_GRADUACAO = "estudante_pos_graduacao", "Estudante de pós-graduação"
        EDUCADOR_POPULAR_PBA = "educador_popular_pba", "Educador(a) Popular (PBA)"
        PROFESSOR_ALFABETIZADO = "professor_alfabetizado", "Professor (a) Alfabetizado (a)"
